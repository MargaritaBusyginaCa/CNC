...
public class Checklist2Activity_2 extends AppCompatActivity {
    public static boolean checklist2completed;
    Button bt_submit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checklist2_p2);
